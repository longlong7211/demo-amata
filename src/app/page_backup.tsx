...
export default function Home() {
    ...
    const renderTabContent = () => {
        ...
        const areaPositions = {
            ...
            area3: { top: '85%', left: '5%', minWidth: '420px', maxWidth: '520px' },
            area4: { top: '110%', left: '5%', minWidth: '390px', maxWidth: '460px' }
        };
            ...
            {showDetails && (
                <div className="details-panel">
                    {activeTab === 'info' ? (
                        ...
                        // Floor views take full screen with zoom animation
                        <div style={{
                            width: '100%',
                            height: '100%',
                            position: 'relative',
                            opacity: showFloor ? 1 : 0,
                            transform: showFloor ? 'scale(1)' : 'scale(0.8)',
                            transition: 'all 0.3s ease'
                        }}>
                            <button
                                className="close-button-content"
